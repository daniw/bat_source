...
HAL_StatusTypeDef w25n01gv_read_reg(w25n01gv_handle *hw25n01gv) {
	HAL_StatusTypeDef status;
	status = w25n01gv_read_reg_prot(hw25n01gv, &hw25n01gv->reg_prot);
	if (status == HAL_OK) {
		status = w25n01gv_read_reg_conf(hw25n01gv, &hw25n01gv->reg_conf);
	}
	if (status == HAL_OK) {
		status = w25n01gv_read_reg_status(hw25n01gv, &hw25n01gv->reg_status);
	}
	return status;
}
