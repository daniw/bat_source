...
static const uint8_t aux_io_ctrl_mode_config[STATEMACHINE_MODE_RESERVED] = {
    ...
    [STATEMACHINE_MODE_RESISTANCE_1A]    = GPIO_MASK_OUT_SEL_ISO | GPIO_MASK_SHUNT_EN | GPIO_MASK_DISCHARGE,
    [STATEMACHINE_MODE_RESISTANCE_1mA]   = GPIO_MASK_OUT_SEL_ISO | GPIO_MASK_SHUNT_EN | GPIO_MASK_DISCHARGE,
    [STATEMACHINE_MODE_ISOMETER]  = GPIO_MASK_OUT_SEL_HV | GPIO_MASK_SHUNT_ISO_EN | GPIO_MASK_DISCHARGE,
    [STATEMACHINE_MODE_VOLTMETER] = GPIO_MASK_OUT_SEL_ISO | GPIO_MASK_OUT_SEL_HV| GPIO_MASK_DISCHARGE,
    [STATEMACHINE_MODE_SETTINGS]  = 0,
