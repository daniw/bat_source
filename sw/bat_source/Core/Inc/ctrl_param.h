...
#define CTRL_PARAM_VOLTAGE_P 0.01F
#define CTRL_PARAM_VOLTAGE_I (1.0F/CTRL_FREQ)

#define CTRL_PARAM_VOLTAGE_DUTY_SAT_HIGH 0.2F
#define CTRL_PARAM_VOLTAGE_DUTY_SAT_LOW 0.0F
